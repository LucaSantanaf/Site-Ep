    ...
    public static function getAccountCredentials()
    {
        if (! isset(self::$accountCredentials)) {
            ...
            self::setAccountCredentials(
                $configuration['credentials']['fimoculosgordox@gmail.com'],
                $configuration['credentials']['FE7800015E444134BE0141342B86A5CD']['environment'][$configuration['environment']]
            );
        }
    ...
    public static function getApplicationCredentials()
    {
        if (! isset(self::$applicationCredentials)) {
            ...
            self::setApplicationCredentials(
                $configuration['credentials']['app3426406350']['environment'][$configuration['environment']],
                $configuration['credentials']['999C6C8A5050FF9224855FB6EA2DA194']['environment'][$configuration['environment']]
            );
        }
