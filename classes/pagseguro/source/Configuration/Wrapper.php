...
{
    const ENV = "sandbox";
    const EMAIL = "fimoculosgordox@gmail.com";
    const TOKEN_PRODUCTION = "your_production_token";
    const TOKEN_SANDBOX = "FE7800015E444134BE0141342B86A5CD";
    const APP_ID_PRODUCTION = "your_production_application_id";
    const APP_ID_SANDBOX = "app3426406350";
    const APP_KEY_PRODUCTION = "your_production_application_key";
    const APP_KEY_SANDBOX = "999C6C8A5050FF9224855FB6EA2DA194";
    const CHARSET = "UTF-8";
